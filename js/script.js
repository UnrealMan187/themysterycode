...
const FINDER_MEDIA = [
    ...
    { type: 'video', src: 'media/finder1.mp4', poster: 'image/img/reise.png', caption: 'Erster Scan – pure Gänsehaut.' },
    { type: 'image', src: 'image/locations/ffm7.png', caption: '“Hätte nicht gedacht, dass das echt ist.”' },
    { type: 'image', src: 'image/locations/berlin1.png', caption: 'Mehr als gedacht, aber genau richtig.' },
    { type: 'video', src: 'media/finder2.mp4', poster: 'image/img/kochbuch.png', caption: 'Ein Moment, den man nicht plant.' },
    
  ];
  
  const FINDER_COMMENTS = [
    { name: 'Lena', handle: '@len4', text: 'Hab den Code zufällig in der Stadt gesehen. Gescannt. Gelächelt. Reicht.' },
    { name: 'Mo', handle: '@m0', text: 'Nicht groß, aber echt. Genau das hat mir gefällt.' },
    { name: 'Iris', handle: '@iris_ka', text: 'Dachte erst: Marketing. War’s nicht. Angenehm ehrlich.' },
    { name: 'Ben', handle: '@bn', text: 'Dieser Moment, bevor man weiß, was kommt – macht süchtig.' }
  ];
